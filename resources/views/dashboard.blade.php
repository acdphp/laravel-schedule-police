...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('/vendor/schedule-control/bootstrap.min.css') }}" rel="stylesheet">
        <link href="{{ asset('/vendor/schedule-control/app.css') }}" rel="stylesheet">
    </head>
    <body>
        ...
        <script src="{{ asset('/vendor/schedule-control/bootstrap.min.js') }}"></script>
        <script src="{{ asset('/vendor/schedule-control/app.js') }}"></script>
    </body>
</html>
